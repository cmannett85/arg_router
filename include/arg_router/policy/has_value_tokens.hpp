...
struct basic_has_value_tokens_t {
};
}  // namespace detail
 ...
 * types.
 */
using has_value_tokens_t = detail::basic_has_value_tokens_t<>;
 ...
 */
template <typename T>
using has_value_tokens = std::is_base_of<has_value_tokens_t, T>;
 ...
 */
template <typename T>
constexpr bool has_value_tokens_v = has_value_tokens<T>::value;

template <>
struct is_policy<has_value_tokens_t> : std::true_type {
};
}  // namespace policy
}  // namespace arg_router
